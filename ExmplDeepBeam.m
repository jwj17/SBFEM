...
%ltx displacement constraints (or prescribed acceleration in a response 
%ltx  history analysis). One constraint per row: \texttt{[Node Dir Disp]}
BC_Disp = [1 1 0; 1 2 0; 2 1 0; 2 2 0; 3 1 0; 3 2 0];

%ltx assemble nodal forces 
