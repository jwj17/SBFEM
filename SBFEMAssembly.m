function [sdSln, K, M] = SBFEMAssembly(probdef, coord, sdConn, sdSC, mat ,sdMat)
...
%ltx {\bf Solution of S-elements}
Nsd = length(sdConn); %ltx number of S-elements
sdSln = cell(Nsd,1); %ltx store solutions for S-elements
...
%ltx sum of entries of stiffness matrices of all S-elements
...
for isd = 1:length(sdSln) %ltx loop over S-elements
