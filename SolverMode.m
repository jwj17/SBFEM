...
%Compute natrural frequencies and mode shapes
...
%ltx initialization of free DOFs with unknown displacements
FDofs = 1:NDof;
if ~isempty(BC_Disp)
...
%ltx initialize model shapes to include constrained DOFs
